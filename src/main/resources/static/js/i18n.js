...
const I18n = (function() {
    ...
    const translations = {
        'zh-CN': {
            ...
            'ui.chat.header': '💬 对话学习',
            'ui.chat.placeholder': '输入你的问题...（Enter 换行，Ctrl+Enter 发送）',
            'ui.chat.sendButton': '发送 (Ctrl+Enter)',
        ...
        'en-US': {
            ...
            'ui.chat.placeholder': 'Enter your question... (Enter for new line, Ctrl+Enter to send)',
            'ui.chat.sendButton': 'Send (Ctrl+Enter)',
